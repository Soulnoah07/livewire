    ...
    <section>
      <article class="full-content">
        <section class="main-content">
          <h2>
            Hello,I'm <h1 class="myname">MUTHEESWARAN</h1>
          </h2>
          <h1>
            You can call me <span class="nickname">NOAH </span>
          </h1>
          <h2 class="domain">MERN STACK DEVELOPER</h2>
          <h2>I build thing for web.</h2>
          <p>
            I'm a passinoate developer who loves turning ideas into clean,
      ...
      <article class="about-container" id="about">
        <section class="full-about">
          <div class="about-container1">
            ...
            <p>
              I'm a passinoate full stack developer who loves turning ideas into
              real-world applications. I enjoy solving problems. learning new
              technologies, and building clean, efficient codes.
            </p>
            <table>
              <tr>
                <td>Name</td>
            ...
            <a href="./images/Mutheeswaran CV.pdf" download="mutheeswaran.pdf">
              Download CV
            </a>
          </div>
